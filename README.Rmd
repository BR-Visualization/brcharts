...
<details>
<summary>Click to learn more about Figure 2 - Demographics (Pyramid Chart)</summary>
...
<details>
<summary>Click to view sample code for Figure 2 - Demographics (Pyramid Chart)</summary>
...
<details>
<summary>Click to learn more about Figure 3 - Disease History (Line Chart)</summary>
...
<details>
<summary>Click to view sample code for Figure 3 - Disease History (Line Chart)</summary>
```{r, echo = TRUE, eval=FALSE}
...
<details>
<summary>Click to learn more about Figure 4 - Comorbidities (Grouped Bar Chart)</summary>
...
<details>
<summary>Click to view sample code for Figure 4 - Comorbidities (Grouped Bar Chart)</summary>
```{r, echo = TRUE, eval=FALSE}
grouped_barchart(
...
<details>
<summary>Click to learn more about Figure 5 - Value Tree</summary>
...
<details>
<summary>Click to view sample code for Figure 5 - Value Tree</summary>
```{r, echo = TRUE, eval = FALSE}
 value_tree(
   diagram =
     "graph LR;
...
```{r value_tree, message = FALSE, echo = FALSE, fig.width = 5, fig.height = 5.3}
...
<details>
<summary>Click to learn more about Figure 6 - Dot-Forest Plot</summary>
...
<details>
<summary>Click to view sample code for Figure 6 - Dot-Forest Plot</summary>
```{r, echo = TRUE, eval=FALSE}
...
```{r forest_dot_plot, message = FALSE, echo = FALSE, fig.width = 6, fig.height = 8}
forest_dot_plot(effects_table,
  filters = "None",
  category = "All",
  type_graph = "Absolute risk",
...
<details>
<summary>Click to learn more about Figure 7 - Trade-off Plot</summary>
...
<details>
<summary>Click to view sample code for Figure 7 - Trade-off Plot</summary>
```{r, echo = TRUE, eval=FALSE}
...
<details>
<summary>Click to learn more about Figure 10 - Correlogram</summary>
...
<details>
<summary>Click to view sample code for Figure 10 - Correlogram</summary>
```{r, echo = TRUE, eval=FALSE}
...
<details>
<summary>Click to learn more about Figure 11 - Scatterplot</summary>
...
<details>
<summary>Click to view sample code for Figure 11 - Scatterplot</summary>
```{r, echo = TRUE, eval=FALSE}
...
<details>
<summary>Click to learn more about Figure 12 - Composite Outcome (Stacked Bar Chart)</summary>
...
<details>
<summary>Click to view sample code for Figure 12 - Composite Outcome (Stacked Bar Chart)</summary>
```{r, echo = TRUE, eval=FALSE}
stacked_barchart(
  data = comp_outcome,
...
<details>
<summary>Click to learn more about Figure 13 - Cumulative Excess Plot</summary>
...
<details>
<summary>Click to view sample code for Figure 13 - Cumulative Excess Plot</summary>
```{r, echo = TRUE, eval=FALSE}
gensurv_combined(
